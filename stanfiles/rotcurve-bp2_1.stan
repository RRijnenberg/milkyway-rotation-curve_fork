/*
* Model fit with static v0 from the BP paper.
* V0 = 234.0 km/s
* 
* Next version 2_2 will contain v0 as a seperate parameter.
* 
* 
* 
* 
...
functions{
  array[] vector predicted_proper_motions(vector plx, array[] vector r, vector sunpos, 
    ...
    real v0 = 234.0/Vcirc_sun; // 234.0 taken as base value from rotcurve-bp.py. Look at paper to find the source.
